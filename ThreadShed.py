...
for transaction in daily_transactions_split:
  ...
  for i in range(len(transaction)):
    transaction_stripped.append(transaction[i].strip(" ").strip("\n").strip(" "))
...
print("Total sales for today: ${x}".format(x=round(total_sales,2)))
...
for color in colors:
  print("The amount of {} thread sold is: {}".format(color,color_count(color)))
